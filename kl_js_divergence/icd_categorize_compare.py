...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--out_dir", default="results/kl_js_divergence",
                   help="Root output directory")
    p.add_argument("--icd_dict",
                   default="AgentClinic/icd10cm_2026.jsonl",
                   help="Path to ICD-10-CM JSONL dictionary")
    p.add_argument("--cache_file",
                   default="results/kl_js_divergence/icd10_mapping_cache.json",
