...
Default output directories:
  diagnosis matrix    → performance_estimation/history_borrowing_result/all_orders/diagnosis/
  conversation matrix → performance_estimation/history_borrowing_result/all_orders/conversation/
...
Usage:
    python performance_estimation/run_all_orders.py
    python performance_estimation/run_all_orders.py \
        --similarity_csv performance_estimation/similarity_matrix/conversation_similarity_matrix.csv
    python performance_estimation/run_all_orders.py --output_dir my/custom/dir
"""
...
BASE_OUTPUT_DIR = Path("performance_estimation/history_borrowing_result/all_orders")
...
def main():
    ...
    parser.add_argument(
        "--replicate_map_json",
        default="performance_estimation/replicate_map.json",
    )
    parser.add_argument(
        "--alpha_grid",
    ...
    for i, order in enumerate(all_perms, 1):
        ...
        cmd = [
            sys.executable, "performance_estimation/history_borrowing.py",
