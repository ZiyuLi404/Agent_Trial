...
Usage:
    # Diagnosis (default)
    python performance_estimation/visualize_borrow_params.py

    # Conversation
    python performance_estimation/visualize_borrow_params.py --source conversation

    # Custom output path
    python performance_estimation/visualize_borrow_params.py \
        --source diagnosis \
        --output performance_estimation/diagnosis_visualization.png
"""
...
def main():
    ...
    parser.add_argument(
        "--output", default=None,
        help="Output PNG path (default: performance_estimation/<source>_visualization.png).",
    )
    args = parser.parse_args()

    source      = args.source
    output_path = args.output or f"performance_estimation/{source}_visualization.png"
