...
Usage:
    python performance_estimation/history_borrowing.py \
        --accuracy_csv performance_estimation/accuracy_by_25_cases.csv \
        --similarity_csv performance_estimation/similarity_matrix.csv \
        --replicate_map_json performance_estimation/replicate_map.json \
        --output_csv performance_estimation/history_borrowing_results.csv \
        --output_summary_json performance_estimation/history_borrowing_summary.json
"""
...
def main() -> None:
    ...
    parser.add_argument(
        "--accuracy_csv",
        default="performance_estimation/accuracy_by_25_cases.csv",
        help="Accuracy CSV produced by accuracy_summary.py.",
    )
    parser.add_argument(
        "--similarity_csv",
        default="performance_estimation/similarity_matrix/diagnosis_similarity_matrix.csv",
        help=(
            "Pairwise similarity matrix CSV "
            "(default: performance_estimation/similarity_matrix/diagnosis_similarity_matrix.csv). "
            "Use e.g. --similarity_csv performance_estimation/similarity_matrix/conversation_similarity_matrix.csv "
            "to switch matrices."
        ),
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--output_csv",
        default="performance_estimation/history_borrowing_result/history_borrowing_results.csv",
        help="Output CSV with per-model results (default: performance_estimation/history_borrowing_result/).",
    )
    parser.add_argument(
        "--output_summary_json",
        default="performance_estimation/history_borrowing_result/history_borrowing_summary.json",
        help="Output JSON with best hyperparameters and MAE summary (default: performance_estimation/history_borrowing_result/).",
    )
    parser.add_argument(
        "--alpha_grid",
...
# ---------------------------------------------------------------------------
#
# python performance_estimation/accuracy_summary.py \
#   --groundtruth_dir performance_estimation/groundtruth \
#   --bucket_size 25 \
#   --output_csv performance_estimation/accuracy_by_25_cases.csv
#
...
# python performance_estimation/history_borrowing.py \
#   --accuracy_csv performance_estimation/accuracy_by_25_cases.csv \
#   --similarity_csv performance_estimation/similarity_matrix/conversation_similarity_matrix.csv \
#   --replicate_map_json performance_estimation/replicate_map.json \
#   --output_csv performance_estimation/history_borrowing_result/conversation_results.csv \
#   --output_summary_json performance_estimation/history_borrowing_result/conversation_summary.json
