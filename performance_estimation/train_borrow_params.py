...
Inputs
------
  performance_estimation/history_borrowing_result/all_orders/diagnosis/
  performance_estimation/history_borrowing_result/all_orders/conversation/

Outputs
-------
  performance_estimation/borrow_params.json       -- best hyperparameters
  performance_estimation/borrow_params_summary.csv -- per-permutation summary
  performance_estimation/borrow_params_full.csv   -- long-form model-level detail

Usage
-----
  python performance_estimation/train_borrow_params.py

  python performance_estimation/train_borrow_params.py \
      --diagnosis_dir   performance_estimation/history_borrowing_result/all_orders/diagnosis \
      --conversation_dir performance_estimation/history_borrowing_result/all_orders/conversation \
...
def main() -> None:
    ...
    parser.add_argument(
        "--diagnosis_dir",
        default="performance_estimation/history_borrowing_result/all_orders/diagnosis",
    )
    parser.add_argument(
        "--conversation_dir",
        default="performance_estimation/history_borrowing_result/all_orders/conversation",
    )
    ...
    parser.add_argument(
        "--output_params",
        default="performance_estimation/borrow_params.json",
    )
    parser.add_argument(
        "--output_summary",
        default="performance_estimation/borrow_params_summary.csv",
    )
    parser.add_argument(
        "--output_full",
        default="performance_estimation/borrow_params_full.csv",
    )
