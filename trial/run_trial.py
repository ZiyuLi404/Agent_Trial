...
# Allow running directly (`python trial/run_trial.py`) as well as via
# `python -m trial.run_trial`: ensure the repo root is on sys.path so that
# `trial.*` and `AgentClinic.*` resolve regardless of how this is launched.
...
from trial.version_manager import get_current_version, open_new_version
from trial.trial_manager import stream_cases, parse_cases, run_case
from trial.logger import log_case
