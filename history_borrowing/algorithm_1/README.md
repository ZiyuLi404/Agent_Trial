# Algorithm 1 — Convex History Borrowing / Performance Estimation
...
```bash
# from the repo root
python history_borrowing/algorithm_1/accuracy_summary.py --groundtruth_dir history_borrowing/data/groundtruth
python history_borrowing/algorithm_1/history_borrowing.py --accuracy_csv ... --similarity_csv ...
